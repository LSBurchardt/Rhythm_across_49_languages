...
group_ordered_ipu <- with(sub_data_ipu,                     # Order boxes by median
                      reorder(Language,
                              ioi_beat,
                              median))
...
```{r age_facet_word, fig.height=40}
